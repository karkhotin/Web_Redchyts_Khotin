...
cl();	// первый вызов размещаю после определения объекта
	 ...
	 <nav>
	  ...
	  <li>
		...
		<li>
          <a href="ajax003.html">Додати коментар</a>
        </li>
...
makeMeteoInformer("https://meteo.ua/informer/get.php?cities=34&w=210&lang=ua&rnd=1&or=vert&clr=0&dt=today&style=classic",200,150);
  ...
  font-weight: bold;
  height: 50px;
  font-size: 16pt;">Читати далі </button>
		<p id="more"></p>
        </p>
...
<script>
	...
	xmlhttp.onreadystatechange = function() {
		...
		if(xmlhttp.status === 200) { 
			more.innerHTML = xmlhttp.responseText;
		} else {
			more.innerHTML = 'An error occurred during your request: '
