...
echo "<tr><th>Назва ресурсу</th><th>Тип ресурсу</th><th>Посилання</th></tr>";
...
try {
    ...
    $stmt = $conn->prepare("SELECT  name, Tres, link FROM resources");
    $stmt->execute();
...
?>
  ...
  <section class="column">
    <a class="article" href="#">
      ...
      <div class="article-body tip" data = "Функціонал">
	  <ul>
       <li>
          <a href="creating.php" >Додати ресурс </a>
        </li>
		<li>
          <a href="fsearch.php" >Пошук ресурсу</a>
        </li>
		<li>
          <a href="edit.php" >Оновлення ресурсу</a>
        </li>
		<li>
          <a href="delete.php" >Видалення ресурсу</a>
        </li>
		</ul>
      </div>
